...
## <b style="color:DodgerBlue;">Solutions</b>
...
<b style="color:DodgerBlue;">Solutions

1. a board
2. display a board
3. update a board
4. state to determine when the game is over
5. get users' choices 
6. Validate the users' choice
...
Verbs are methods, nouns are variables
...
1. a board - variable
2. display a board - method
3. update a board - method
4. state to determine when the game is over - variable
5. get users' choices  - method
6. Validate the users' choice - method
...
1. Ask the players' for their names
2. Store the players' names
3. Create an empty board
4. Repeat until the game is over:
	1. ask a user for their choice
	2. validate the users choice:
		1. repeat asking until the users choice is valid 
	3. check the state of the game, did the previous move result in a win or tie
	4. If not, repeat loop but with the other player
...
<b style="color:DodgerBlue;">Solution
...
**TODO: Question 2.7.1:** In your java program, now implement each method. When you implement one method, make sure to test it in the main method. 
